...
class Plugwise:
    ...
    def GetCRC16(self, value):
        ...
        #print "CRC16 :: " + str(value)
        format = ("%%0%dX" % ((CRC16X.width + 3) // 4))   # Passage de décimal en héxadécimal.
        #print "FORMAT VALUE ||| " + format%value
        return format % value                             # Retourne la format héxa.
    ...
    def SendCommand(self, command):
        ...
        #print "Message envoyé : " + self.HEADER + command + self.GetCRC16(command) + self.ENDLINE
